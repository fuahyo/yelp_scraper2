  ...
  if parsable
    ...
    unless unwanted_cuisines.include?(main_cuisine)
      ...
      if rating.nil?
        ...
        rating ||= Float(html.at('yelp-react-root > div > div[class*="arrange"]')['aria-label'][/([\d\.]+) star/, 1]) rescue nil
